...
class AddMessageForm extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        let newMessage = {message: this.state.msgBox, username: this.state.usernameBox, timestamp: null, id: null};
        ...
        return <div className={"container-div"}>
            ...
            <div className={"msgForm"}>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" id={"usernameBox"} onChange={this.handleChangeUsr}/>
                    </div>
                    <div>
